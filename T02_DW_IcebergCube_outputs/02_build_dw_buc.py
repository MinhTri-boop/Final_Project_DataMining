...
Run:
    python 02_build_dw_buc.py --input gtd_cleaned.csv --outdir outputs_t02 --min_sup 100
...
def main() -> None:
    ...
    parser.add_argument("--input", default="gtd_cleaned.csv")
    parser.add_argument("--outdir", default="outputs_t02")
